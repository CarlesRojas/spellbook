    ...
    return (
        <div className="prose prose-stone m-auto h-fit w-full max-w-screen-lg px-4 py-8 dark:prose-invert">
            ...
            <ul>
                ...
                <li>
                    <p>
                        <strong>Application</strong> refers to SpellBook, the software program provided by the Company.
                    </p>
                </li>
                <li>
                    <p>
                        <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                        &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to SpellBook.
                    </p>
                </li>
                <li>
                    <p>
                ...
                <li>
                    <p>
                        <strong>Website</strong> refers to SpellBook, accessible from{" "}
                        <a href="https://www.spellbookdnd.com" rel="external nofollow noopener" target="_blank">
                            https://www.spellbookdnd.com
                        </a>
                    </p>
                </li>
                <li>
