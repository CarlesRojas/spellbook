    ...
    return (
        <div className="prose prose-stone dark:prose-invert m-auto h-fit w-full max-w-screen-lg px-4 py-8">
            ...
            <p>
                ...
                mobile devices that was created by Pinya Apps (hereby referred to as &quot;Service Provider&quot;) as a
            ...
            <div>
                ...
                <ul>
                    ...
                    <li>
                        Analytics and Improvements: Aggregated and anonymized location data helps the Service Provider
                        to analyze user behavior, identify trends, and improve the overall performance and functionality
                        of the Application.
                    </li>
                    <li>
                        Third-Party Services: Periodically, the Service Provider may transmit anonymized location data
            ...
            <p>
                ...
                via the Application, please contact them at spellbook@carlesrojas.com and they will respond in a
                reasonable time.
            </p>
            ...
            <div>
                <p>
                    ...
                    please contact the Service Provider (spellbook@carlesrojas.com) so that they will be able to take
            ...
            <p>
                ...
                practices, please contact the Service Provider via email at spellbook@carlesrojas.com.
            </p>
        </div>
    );
};
