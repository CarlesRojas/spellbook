const TermsAndConditions = () => {
    return (
        <div className="prose prose-stone m-auto h-fit w-full max-w-screen-lg px-4 py-8 dark:prose-invert">
            ...
            <p>
                These terms and conditions applies to the SpellBook app (hereby referred to as &quot;Application&quot;)
                for mobile devices that was created by Pinya Apps (hereby referred to as &quot;Service Provider&quot;)
                as a Free service.
            </p>
            ...
            <p>These terms and conditions are effective as of 2024-01-01</p>

            <h2>Contact Us</h2>
            <p>
                If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to
                contact the Service Provider at spellbook@carlesrojas.com.
            </p>
        </div>
    );
};
