            ...
            <DropdownMenuTrigger>
                <div className="focus-ring group hidden rounded-full md:flex mouse:flex">
                    {user.data ? (
                        ...
                        >
                            <LuSettings className="mouse:group-hover:text-orange-500" />
                        </Button>
                    )}
                </div>
                ...
                <div className="focus-ring group flex h-12 max-h-12 w-full md:hidden mouse:hidden">
                    <Button asChild variant="link" aria-label="Open Settings" className="relative h-full w-full p-0">
                        <NavbarItem
                            ...
                            icon={<LuSettings className="h-6 w-6 mouse:group-hover:text-orange-500" />}
                        />
                    </Button>
                </div>
            </DropdownMenuTrigger>
                        ...
                        <DropdownMenuSubContent>
                            {Object.values(Language).map((currentLanguage) => (
                                <Link href={`/${currentLanguage}${pathnameWithoutLanguage}`} key={currentLanguage}>
                                    <DropdownMenuItem
                                        className={`font-semibold ${currentLanguage === language ? "!text-orange-500" : ""}`}
                                    >
