...
const Header = ({ language }: Props) => {
    ...
    const header = (children?: ReactNode) => (
        <header className="fixed left-0 right-0 top-0 z-50 hidden h-16 items-center justify-between border-b border-stone-300 bg-stone-100 px-3 py-2 dark:border-stone-800 dark:bg-stone-950 md:flex md:px-4 mouse:flex">
